  ...
  return (
    <div>
      ...
      {href && linkLabel ? (
        <Link
          href={href}
          className="mt-2 inline-block text-sm text-zinc-600 underline decoration-zinc-300 underline-offset-4 transition hover:text-teal-700 hover:decoration-teal-700 dark:text-zinc-400 dark:decoration-zinc-600 dark:hover:text-teal-400 dark:hover:decoration-teal-400"
        >
          {linkLabel} ↗
        </Link>
      ) : null}
